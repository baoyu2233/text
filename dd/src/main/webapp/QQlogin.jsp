...
<link href="${pageContext.request.contextPath}/css/login/qlogin_v2.min.css" rel="stylesheet">
...
<div id="combine_page" style="width: 688px;">
  <div class="page_login combine_page_children float_left border_right">
    <div class="lay_login_form">
      ...
      <iframe frameborder="0" width="370" height="322" id="ptlogin_iframe" name="ptlogin_iframe" src="${pageContext.request.contextPath}/xQQlogin.jsp"></iframe>
  ...
  <div class="page_accredit combine_page_children float_left">
    <div class="lay_main" id="lay_main">
      <div class="lay_accredit_con">
        <p class="cnt_wording">该网站已有超过1百万用户使用QQ登录</p>
        <p class="app_site_wording"><a class="accredit_site" id="accredit_site_link" href="http://www.10010.com/" target="_blank">中国联通官网</a>将获得以下权限：</p>
...
<!-- <script>
    ...
    Q.authsCount = 1;
    Q.isNeedLogin = false;
    Q.crtDomain = 'http://www.10010.com';
    Q.agree = function(){
    ...
    if (!window.JSON) {
    	document.write('<script type="text/javascript" src="${pageContext.request.contextPath}/https://imgcache.qq.com/open/operate/mlib/widget/json-for-ie.js"><\/script>');
    }
</script>
 -->
<!--@fragment_bottom Start-->
<!-- <script src="${pageContext.request.contextPath}/./QQ帐号安全登_files/pt_adapt.js,qlogin_v2.js.下载" charset="UTF-8"></script>
<script>
    document.write('<script src="${pageContext.request.contextPath}/https://tajs.qq.com/stats?sId=52725868" charset="UTF-8"><\/script>');
</script><script src="${pageContext.request.contextPath}/./QQ帐号安全登_files/stats" charset="UTF-8"></script> -->
<!--@fragment_bottom End -->
