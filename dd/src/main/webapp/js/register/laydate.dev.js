...
Dates.viewDate = function(Y, M, D){
    ...
    Dates.each(as.tds, function(i, elem){
        ...
        elem.setAttribute("AClass","AClass");
...
Dates.view = function(elem, options){
    ...
    if(!Dates.box){
        ...
        div.innerHTML =  log.html ='<div class="selTimesTitle"><label>送货时间</label>'
        +'</div>'
        ...
        + Dates.viewtb
            +'<p class="selTimeDesc">将在您指定日期（7月29）后尽快发货，如选择“指定日期配送”则仅支持在线支付。</p>'
            +'<p class="selTimeDescErr" style="display: none;">您选择的时间有误，请重新选择。</p>'
            +'<div class="laydate_bottom">'
            +'<div class="selTimeBtn"><button>确 定</button></div>'
          +'<ul id="laydate_hms" style="display:none;">'
            ...
            +'<li><input readonly></li>'
          +'</ul>'
          +'<div class="laydate_time" id="laydate_time" style="display:none;"></div>'
          +'<div class="laydate_btn" style="display:none;">'
