...
//--url--http://(mall|www|num|s).10010.com/(?!PrePurNotice|pushpage)
/*$(function(){try{$("#searchBtnBox").click(function(){var c=$("#searchInputBox").val(),t=$("#searchType .select").text();_n3fa.push(["_trackEvent","10010","search",c,t])})}catch(c){}});*/
;
(function () {
    var _config = {
        ...
        receiveUrl: "https:" == document.location.protocol ? "//eop.mall.10010.com/_n3fa_img.gif?" : "//eop.mall.10010.com/_n3fa_img.gif?",
        searchEngine: [
    ...
    function sendDataToServerOnTrackStackFull(_fa) {
        if (0 != _fa.trackStack.length)
            _fa.a.et = 2, _fa.a.ep = "[" + _fa.trackStack.join(",") + "]", _fa.trackStack = []
    }
